...
object GroupsAPI {
  ...
  val postApiAdminGroups: Endpoint[String, CreateGroupRequestDtp, ApiError, String, Any] =
    endpoint.post
  ...
  val getApiAdminGroups: Endpoint[String, Unit, ApiError, GroupsResponse, Any] =
    endpoint.get
      .securityIn(auth.bearer[String]())
      .in("api" / "admin" / "groups")
      .errorOut(
